...
class AuthenticationMiddleware:
    ...
    async def verify_auth(request: Request) -> Dict[str, Any]:
        ...
        # SECURITY FIX: Encode both strings to utf-8 before passing to compare_digest to prevent
        # TypeError (and potential 500 crashes) when api_key contains non-ASCII characters
