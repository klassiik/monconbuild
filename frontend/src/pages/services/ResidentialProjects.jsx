...
const ResidentialProjects = () => {
  ...
  const serviceSchema = {
    ...
    "description": "Complete residential construction and remodeling services including new home construction, renovations, and home improvement projects in Placer, Nevada, Sacramento, Yolo, and El Dorado Counties.",
  ...
  return (
    <div className="min-h-screen">
      <Head>
        <title>Residential Construction | Colfax & Placer County CA</title>
        ...
        <meta property="og:title" content="Residential Construction | Colfax & Placer County CA" />
