...
const CustomWoodwork = () => {
  ...
  const serviceSchema = {
    ...
    "description": "Master craftsmanship in custom woodwork, cabinetry, and artisan furniture pieces for homes in Placer, Nevada, Sacramento, Yolo, and El Dorado Counties.",
  ...
  return (
    <div className="min-h-screen">
      <Head>
        <title>Custom Woodwork & Cabinetry | Colfax & Placer County CA</title>
        ...
        <meta property="og:title" content="Custom Woodwork & Cabinetry | Colfax & Placer County CA" />
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-200">
              Master craftsmanship in custom wood design for homes across Placer, Nevada, Sacramento, Yolo & El Dorado Counties
            </p>
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              ...
              craftsmanship with modern techniques to deliver exceptional results. Licensed contractor <a href="https://www.cslb.ca.gov/801602" target="_blank" rel="noopener noreferrer" className="text-green-700 hover:text-blue-800 underline">#801602</a>.
            </p>
            ...
            <ServiceAreasBlock intro="Custom woodwork services throughout Northern California:" />
          </div>
        </div>
      </section>
