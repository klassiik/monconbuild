...
// ⚡ Bolt: Hoisted featuredSlideImages map outside of Home to prevent creating a new array
// reference on every render, allowing ImageGallery's preload useEffect to run properly.
