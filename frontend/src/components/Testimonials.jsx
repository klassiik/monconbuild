...
// ⚡ Bolt: Hoist static stars array outside the component to prevent recreating
// 5 React elements on every render. Because React elements are plain immutable
// objects, a static array of them can be safely reused across renders without
// allocating new memory.
const STATIC_STARS = [...Array(5)].map((_, i) => (
  <Star
    key={i}
