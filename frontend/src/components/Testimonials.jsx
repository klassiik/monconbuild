...
// ⚡ Bolt: Hoist static stars array outside the component to prevent unnecessary recreation
// and memory allocation on every render of the Testimonials component.
